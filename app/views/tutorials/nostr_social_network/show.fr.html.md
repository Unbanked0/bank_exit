...
Si vous souhaitez découvrir Nostr de manière théorique, un [article de blog dédié](<%= blog_path("nostr-protocol") %>) est déjà disponible sur ce site pour vous accompagner.
