> [!IMPORTANT]
> The **Bank-Exit collective** provides a tutorial designed for professionals who want to accept **Bitcoin** or **Monero** payments while maintaining simple accounting records. The goal is to help merchants integrate these new payment methods into their everyday business activities.
...
_Settings and explanations_

![Manual transaction import](<%= image_path("tutorials/accountings/Compta_fisca_crypto_libre_V1.2_2025_03.jpg") %>)
_Manual transaction import_

![Accounting results](<%= image_path("tutorials/accountings/Compta_fisca_crypto_libre_V1.2_2025_04.jpg") %>)
_Accounting results_
...
1. Choose a suitable wallet to receive payments.
2. Inform customers that Bitcoin or Monero are accepted.
3. Record received transactions.
4. Regularly perform the necessary accounting follow-up.
...
> [!TIP]
> Are you a merchant interested in accepting Bitcoin or Monero? Start simply: install a wallet, run a few tests, then set up a regular tracking process suited to your business.
